...
public final class ForgePermissionNodes {
    ...
    public static void register() {
        PermissionGatherEvent.Nodes.BUS.addListener(ForgePermissionNodes::registerNodes);
    }
    ...
    private static boolean isOp(ServerPlayer player) {
        return player != null && player.level().getServer().getPlayerList().isOp(new NameAndId(player.getGameProfile()));
    }
